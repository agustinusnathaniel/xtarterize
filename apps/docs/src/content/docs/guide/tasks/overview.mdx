...
| `quality/lint-staged` | Install [lint-staged](https://github.com/okonet/lint-staged), write [`.lintstagedrc.json`](https://github.com/okonet/lint-staged#configuration) running Biome on staged files | Always |
...
| Task ID | Description | Applicable When |
|---------|-------------|-----------------|
| `editor/editorconfig` | Write [`.editorconfig`](https://editorconfig.org/) with consistent indentation, charset, and line endings | Always |
...
| `scripts/nvmrc` | Write [`.nvmrc`](https://github.com/nvm-sh/nvm#nvmrc) with `lts/*` to pin Node.js version | Always |

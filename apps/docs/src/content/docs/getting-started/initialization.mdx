...
- **Agent** — `AGENTS.md`, [`.agents/skills/`](https://docs.opencode.ai/skills) directory, and install relevant [agent skills](https://skills.sh) via `npx skills@latest add` for your detected stack

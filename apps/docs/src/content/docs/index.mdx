...
<div class="terminal-line output"><span class="success">✓</span> ESLint config applied</div>
<div class="terminal-line output"><span class="success">✓</span> Prettier config applied</div>
<div class="terminal-line output"><span class="success">✓</span> TypeScript strict mode enabled</div>
<div class="terminal-line output"><span class="success">✓</span> EditorConfig created</div>
<div class="terminal-line output"><span class="info">ℹ</span> 5 configs applied · 0 conflicts</div>
...
Every JavaScript/TypeScript project needs ESLint, Prettier, TypeScript, editor configs, and more. Setting them up is tedious. Keeping them consistent across projects is worse.
...
<p>React, Vue, Svelte, Node, Deno, Bun — if it's JS/TS, Xtarterize knows how to configure it.</p>
</div>

...
|------|------------|-----------------|
| [Biome](https://biomejs.dev/) | `@biomejs/biome` | `biome --version` |
| [ESLint](https://eslint.org/) | `eslint` | `eslint --version` |
| [TypeScript](https://www.typescriptlang.org/) | `typescript` | `tsc --version` |
| [Commitlint](https://commitlint.js.org/) | `@commitlint/cli` | `commitlint --version` |
| [Knip](https://knip.dev/) | `knip` | `knip --version` |

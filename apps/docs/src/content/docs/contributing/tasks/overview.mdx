...
- **`createSimpleFileTask`** — For tasks that write a single new file (CI workflows, [renovate](https://docs.renovatebot.com/), [commitlint](https://commitlint.js.org/), [knip](https://knip.dev/), AI skills)
